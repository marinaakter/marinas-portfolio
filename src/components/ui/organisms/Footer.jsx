            ...
            <Container>
                <div className="relative z-10 py-20">
                    <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                        <div>
                            <div className="flex items-center gap-3">
                                <div className="leading-tight">
                                    <p className="text-lg font-bold text-white">{mock.brand.shortName}</p>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-white">{mock.footer.productTitle}</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-white">{mock.footer.companyTitle}</h3>
                            <ul className="mt-6 space-y-4 text-sm text-slate-300">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-white">{mock.footer.newsletterTitle}</h3>
                    ...
                    <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 text-sm text-slate-400 md:flex-row">
                        ...
                        <div className="flex gap-6">
                            {mock.navigation.footerBottom.map((item) => (
                                <a key={item.name} href={item.path} className="transition hover:text-sky-400">
                                    {item.name}
                                </a>
                            ))}
                        </div>

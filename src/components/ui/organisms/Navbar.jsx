...
export default function Navbar() {
    ...
    const mobileMenuLabel =
        mock?.navigation?.mobileMenuLabel || "Toggle menu";
    ...
    return (
        ...
        >
            <Container>
                ...
                >
                    <div className="rounded-[28px] border border-white/10 bg-white/[0.04] p-3 shadow-[0_18px_50px_rgba(0,0,0,0.28)] backdrop-blur-2xl">
